...
function CarListing() {
    return (
        <div>
            ...
            <h1>Our Best <span className="text-blue-600 font-black">Cars</span></h1>
            </div>
                        <div id="vehicles" className="bg-gray-50 pb-10">
                <div className="flex flex-row justify-center">
                    <div><div className="wrapper mx-5 bg-gray-400 antialiased text-gray-900">
<div>
